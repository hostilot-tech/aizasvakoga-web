...
export default function Hero() {
  ...
  return (
    <section id="hero" aria-label="Glavni hero sekcija s pozivom na akciju" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-neutral-950">
      ...
      <div className="container-custom relative z-10">
        <div className="section-padding space-y-12">
          ...
          <div className="text-center space-y-6 max-w-5xl mx-auto">
            ...
            <h1 className="text-heading-xl md:text-display-md lg:text-display-lg font-bold text-white mb-6 leading-tight md:leading-snug md:flex md:flex-col md:items-center">
              <span className="md:whitespace-nowrap">
                Iskoristite <span className="bg-gradient-to-r from-orange-400 to-amber-400 bg-clip-text text-transparent font-extrabold">AI</span> za veću{" "}
                <span className="bg-gradient-to-r from-primary-400 to-primary-300 bg-clip-text text-transparent">učinkovitost</span>,
              </span>{" "}
              <span className="md:whitespace-nowrap">
                bržu <span className="bg-gradient-to-r from-primary-400 to-primary-300 bg-clip-text text-transparent">inovaciju</span> i oštriju
              </span>{" "}
              <span className="md:whitespace-nowrap">
                <span className="bg-gradient-to-r from-primary-400 to-primary-300 bg-clip-text text-transparent">konkurentsku prednost</span>.
              </span>
            </h1>
